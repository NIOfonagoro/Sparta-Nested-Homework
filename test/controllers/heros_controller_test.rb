...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { name: @hero.name, power: @hero.power, universe_id: @hero.universe_id } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { name: @hero.name, power: @hero.power, universe_id: @hero.universe_id } }
