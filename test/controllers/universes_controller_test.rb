...
class UniversesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universe" do
    assert_difference('Universe.count') do
      post universes_url, params: { universe: { movies: @universe.movies, name: @universe.name } }
    end
  ...
  test "should update universe" do
    patch universe_url(@universe), params: { universe: { movies: @universe.movies, name: @universe.name } }
